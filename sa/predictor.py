...
class PhraseSentimentPredictor:
    ...
    def __init__(self, classifier="rnn", classifier_args=None, lowercase=False,
        ...
        self.vocabulary=[]
        import csv
        with open(DATA_PATH + '/vocabulary_cn',encoding='utf-8') as f:
            rd=csv.reader(f)
            for line in rd:
